...
namespace EFCoreMigrationTestWithInheritence_MySql_Updated.Migrations
{
    ...
    [Migration("20231223093910_AddCustomDT")]
    partial class AddCustomDT
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Data.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 12, 23, 10, 39, 10, 342, DateTimeKind.Local).AddTicks(2818),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("c92db414-765b-46dd-bf40-ef7d5a5abd7b"),
                            CreatedDateTime = new DateTime(2023, 12, 23, 10, 39, 10, 342, DateTimeKind.Local).AddTicks(2829),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("Shared.Data.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 12, 23, 10, 39, 10, 342, DateTimeKind.Local).AddTicks(1854),
            ...
            modelBuilder.Entity("Shared.Data.UserType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2023, 12, 23, 10, 39, 10, 341, DateTimeKind.Local).AddTicks(2628),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("c3f257ff-1c85-4e3c-b6b2-21ef4afba71f"),
                            CreatedDateTime = new DateTime(2023, 12, 23, 10, 39, 10, 341, DateTimeKind.Local).AddTicks(2684),
                            Name = "Root"
                        });
                });
