...
namespace EFCoreMigrationTestWithInheritence_MySql_Updated.Migrations
{
    ...
    [Migration("20231224140348_AddCreatedByUser")]
            ...
            modelBuilder.Entity("Shared.Entities.Roles.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 3, 48, 797, DateTimeKind.Local).AddTicks(6364))
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 12, 24, 15, 3, 48, 797, DateTimeKind.Local).AddTicks(6914),
                            Name = "Admin"
                        },
                        new
                        {
                            ...
                            CreatedByUserForeignKey = new Guid("c92db313-765b-46dd-bf40-ef7d5a5abd7b"),
                            CreatedTime = new DateTime(2023, 12, 24, 15, 3, 48, 797, DateTimeKind.Local).AddTicks(6975),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("Shared.Entities.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 3, 48, 789, DateTimeKind.Local).AddTicks(5835))
                        .HasColumnName("created_time");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 12, 24, 15, 3, 48, 796, DateTimeKind.Local).AddTicks(2817),
            ...
            modelBuilder.Entity("Shared.Entities.Users.UserHasRelationToRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 3, 48, 799, DateTimeKind.Local).AddTicks(995))
                        .HasColumnName("created_time");
            ...
            modelBuilder.Entity("Shared.Entities.Users.UserType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 3, 48, 787, DateTimeKind.Local).AddTicks(7154))
                        .HasColumnName("created_time");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedByUserForeignKey = new Guid("c92db313-765b-46dd-bf40-ef7d5a5abd7b"),
                            CreatedTime = new DateTime(2023, 12, 24, 15, 3, 48, 787, DateTimeKind.Local).AddTicks(7679),
                            Name = "User"
                        },
                        new
                        {
                            ...
                            CreatedByUserForeignKey = new Guid("c92db313-765b-46dd-bf40-ef7d5a5abd7b"),
                            CreatedTime = new DateTime(2023, 12, 24, 15, 3, 48, 787, DateTimeKind.Local).AddTicks(7683),
                            Name = "Root"
                        });
                });
