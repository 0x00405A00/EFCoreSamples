...
namespace EFCoreMigrationTestWithInheritence_MySql_Updated.Migrations
{
    ...
    [Migration("20231224140038_TimestampValueNames")]
    partial class TimestampValueNames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Entities.Roles.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 0, 38, 279, DateTimeKind.Local).AddTicks(1934))
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 12, 24, 15, 0, 38, 279, DateTimeKind.Local).AddTicks(2445),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("c92db414-765b-46dd-bf40-ef7d5a5abd7b"),
                            CreatedTime = new DateTime(2023, 12, 24, 15, 0, 38, 279, DateTimeKind.Local).AddTicks(2448),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("Shared.Entities.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 0, 38, 276, DateTimeKind.Local).AddTicks(3237))
                        .HasColumnName("created_time");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 12, 24, 15, 0, 38, 278, DateTimeKind.Local).AddTicks(7868),
            ...
            modelBuilder.Entity("Shared.Entities.Users.UserHasRelationToRole", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 0, 38, 279, DateTimeKind.Local).AddTicks(7006))
                        .HasColumnName("created_time");
            ...
            modelBuilder.Entity("Shared.Entities.Users.UserType", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 12, 24, 15, 0, 38, 274, DateTimeKind.Local).AddTicks(8435))
                        .HasColumnName("created_time");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2023, 12, 24, 15, 0, 38, 274, DateTimeKind.Local).AddTicks(8970),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("c3f257ff-1c85-4e3c-b6b2-21ef4afba71f"),
                            CreatedTime = new DateTime(2023, 12, 24, 15, 0, 38, 274, DateTimeKind.Local).AddTicks(8974),
                            Name = "Root"
                        });
                });
